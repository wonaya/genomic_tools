...
os.system("/opt/apps/bedtools/2.25.0/bin/intersectBed -wa -wb -a "+sortfile1+" /work/02114/wonaya/genome/maize/Zea_mays.AGPv4.33/maize_4.33_w1000.bed > "+sortfile1.split("_sort.bedgraph")[0]+"_merge.bedgraph")
os.system("/opt/apps/bedtools/2.25.0/bin/intersectBed -wa -wb -a "+sortfile2+" /work/02114/wonaya/genome/maize/Zea_mays.AGPv4.33/maize_4.33_w1000.bed > "+sortfile2.split("_sort.bedgraph")[0]+"_merge.bedgraph")
