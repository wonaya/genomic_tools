### point-biserial correlation with FPKM vs. Peak
...
#def make_array(chr, return_dict1,return_dict2) :
#def make_array(chr): 
list_binary = []
list_cont = []
...
for chr in range(1,11):
    ...
    fpkm_gene_dict = {}
    for a in open("/scratch/02114/wonaya/NCSU_HiSeq/05-22-13_Maize_Root_RNAseq_HiSeq/RNA-seq_test/guided_1_318/cufflinks_out/genes.fpkm_tracking", 'r') :
